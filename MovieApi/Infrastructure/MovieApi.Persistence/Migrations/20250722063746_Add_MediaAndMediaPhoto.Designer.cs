...
namespace MovieApi.Persistence.Migrations
{
    ...
    [Migration("20250722063746_Add_MediaAndMediaPhoto")]
    partial class Add_MediaAndMediaPhoto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.CastMovie", b =>
                {
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.CategoryMovie", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.Media", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.MediaPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.TagMovie", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.CastMovie", b =>
                {
                    b.HasOne("MovieApi.Domain.Entities.Cast", "Cast")
                        .WithMany("CastMovies")
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.MediaPhoto", b =>
                {
                    b.HasOne("MovieApi.Domain.Entities.Media", "Media")
            ...
            modelBuilder.Entity("MovieApi.Domain.Entities.TagMovie", b =>
                {
                    ...
                    b.HasOne("MovieApi.Domain.Entities.Tag", "Tag")
                        .WithMany("TagMovies")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
